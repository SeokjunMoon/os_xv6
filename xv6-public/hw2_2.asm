...
int main(int argc, char** argv)
{
  ...
  12:	6a 00                	push   $0x0
  14:	6a 01                	push   $0x1
  16:	e8 10 04 00 00       	call   42b <setnice>
  setnice(getpid(), 2);
  1b:	e8 e3 03 00 00       	call   403 <getpid>
  20:	5a                   	pop    %edx
  21:	59                   	pop    %ecx
  22:	6a 02                	push   $0x2
  24:	50                   	push   %eax
  25:	e8 01 04 00 00       	call   42b <setnice>
  ...
  2c:	6a 00                	push   $0x0
  2e:	6a 01                	push   $0x1
  30:	e8 cb 00 00 00       	call   100 <testgetnice>
  testgetnice(getpid(), 2);
  35:	e8 c9 03 00 00       	call   403 <getpid>
  3a:	5a                   	pop    %edx
  3b:	59                   	pop    %ecx
  3c:	6a 02                	push   $0x2
  3e:	50                   	push   %eax
  3f:	e8 bc 00 00 00       	call   100 <testgetnice>

  child1 = fork();
  44:	e8 32 03 00 00       	call   37b <fork>

  if (child1 == 0) {
  49:	83 c4 10             	add    $0x10,%esp
  4c:	85 c0                	test   %eax,%eax
  4e:	75 42                	jne    92 <main+0x92>
  50:	bb 02 00 00 00       	mov    $0x2,%ebx
  ...
  5b:	53                   	push   %ebx
		for (int i = 0; i < 10; i++) {
  5c:	83 c3 03             	add    $0x3,%ebx
			printf(1, "##### Step %d #####\n", (i * 3) + 2);
  5f:	68 4f 08 00 00       	push   $0x84f
  64:	6a 01                	push   $0x1
  66:	e8 95 04 00 00       	call   500 <printf>
			yield();
  6b:	e8 cb 03 00 00       	call   43b <yield>
		for (int i = 0; i < 10; i++) {
  70:	83 c4 10             	add    $0x10,%esp
  73:	83 fb 20             	cmp    $0x20,%ebx
  ...
  78:	e8 86 03 00 00       	call   403 <getpid>
  7d:	83 ec 04             	sub    $0x4,%esp
  80:	50                   	push   %eax
  81:	68 64 08 00 00       	push   $0x864
  86:	6a 01                	push   $0x1
  88:	e8 73 04 00 00       	call   500 <printf>

  exit();
  8d:	e8 f1 02 00 00       	call   383 <exit>
		child2 = fork();
  92:	e8 e4 02 00 00       	call   37b <fork>
		if (child2 == 0) {
  97:	85 c0                	test   %eax,%eax
  99:	75 27                	jne    c2 <main+0xc2>
  9b:	bb 03 00 00 00       	mov    $0x3,%ebx
				printf(1, "##### Step %d #####\n", (j * 3) + 3);
  a0:	83 ec 04             	sub    $0x4,%esp
  a3:	53                   	push   %ebx
			for (int j = 0; j < 10; j++) {
  a4:	83 c3 03             	add    $0x3,%ebx
				printf(1, "##### Step %d #####\n", (j * 3) + 3);
  a7:	68 4f 08 00 00       	push   $0x84f
  ac:	6a 01                	push   $0x1
  ae:	e8 4d 04 00 00       	call   500 <printf>
				yield();
  b3:	e8 83 03 00 00       	call   43b <yield>
			for (int j = 0; j < 10; j++) {
  b8:	83 c4 10             	add    $0x10,%esp
  bb:	83 fb 21             	cmp    $0x21,%ebx
  be:	75 e0                	jne    a0 <main+0xa0>
  c0:	eb b6                	jmp    78 <main+0x78>
  c2:	bb 01 00 00 00       	mov    $0x1,%ebx
  ...
  d3:	53                   	push   %ebx
			for (int k = 0; k < 10; k++) {
  d4:	83 c3 03             	add    $0x3,%ebx
				printf(1, "##### Step %d #####\n", (k * 3) + 1);
  d7:	68 4f 08 00 00       	push   $0x84f
  dc:	6a 01                	push   $0x1
  de:	e8 1d 04 00 00       	call   500 <printf>
				yield();
  e3:	e8 53 03 00 00       	call   43b <yield>
			for (int k = 0; k < 10; k++) {
  e8:	83 c4 10             	add    $0x10,%esp
  eb:	83 fb 1f             	cmp    $0x1f,%ebx
  ee:	75 e0                	jne    d0 <main+0xd0>
  f0:	eb 86                	jmp    78 <main+0x78>
  f2:	66 90                	xchg   %ax,%ax
  f4:	66 90                	xchg   %ax,%ax
  f6:	66 90                	xchg   %ax,%ax
  f8:	66 90                	xchg   %ax,%ax
...
00000100 <testgetnice>:
{
 100:	55                   	push   %ebp
 101:	89 e5                	mov    %esp,%ebp
 103:	83 ec 14             	sub    $0x14,%esp
  if(getnice(pid) != nice) {
 106:	ff 75 08             	push   0x8(%ebp)
 109:	e8 25 03 00 00       	call   433 <getnice>
 10e:	83 c4 10             	add    $0x10,%esp
 111:	3b 45 0c             	cmp    0xc(%ebp),%eax
 114:	75 02                	jne    118 <testgetnice+0x18>
}
 116:	c9                   	leave  
 117:	c3                   	ret    
 ...
 118:	50                   	push   %eax
 119:	50                   	push   %eax
 11a:	68 28 08 00 00       	push   $0x828
 11f:	6a 01                	push   $0x1
 121:	e8 da 03 00 00       	call   500 <printf>
    exit();
 126:	e8 58 02 00 00       	call   383 <exit>
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 579:	ff 24 85 7c 08 00 00 	jmp    *0x87c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba 73 08 00 00       	mov    $0x873,%edx
        while(*s != 0){
