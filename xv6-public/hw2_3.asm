...
int main(int argc, char** argv)
{
  ...
  13:	6a 00                	push   $0x0
  15:	6a 01                	push   $0x1
  17:	e8 ef 03 00 00       	call   40b <setnice>
  setnice(getpid(), 10);
  1c:	e8 c2 03 00 00       	call   3e3 <getpid>
  21:	5e                   	pop    %esi
  22:	5a                   	pop    %edx
  23:	6a 0a                	push   $0xa
  25:	50                   	push   %eax
  26:	e8 e0 03 00 00       	call   40b <setnice>
  ...
  2d:	6a 00                	push   $0x0
  2f:	6a 01                	push   $0x1
  31:	e8 aa 00 00 00       	call   e0 <testgetnice>
  testgetnice(getpid(), 10);
  36:	e8 a8 03 00 00       	call   3e3 <getpid>
  3b:	5e                   	pop    %esi
  3c:	5a                   	pop    %edx
  3d:	6a 0a                	push   $0xa
  3f:	50                   	push   %eax
  40:	e8 9b 00 00 00       	call   e0 <testgetnice>

  parent = getpid();
  45:	e8 99 03 00 00       	call   3e3 <getpid>
  4a:	89 c6                	mov    %eax,%esi
  child = fork();
  4c:	e8 0a 03 00 00       	call   35b <fork>

  if(child == 0){
  51:	83 c4 10             	add    $0x10,%esp
  54:	85 c0                	test   %eax,%eax
  56:	75 4d                	jne    a5 <main+0xa5>
	printf(1, "##### Step 2 #####\n");
  58:	51                   	push   %ecx
  59:	51                   	push   %ecx
  5a:	68 2f 08 00 00       	push   $0x82f
  5f:	6a 01                	push   $0x1
  61:	e8 7a 04 00 00       	call   4e0 <printf>
	setnice(parent, 2);
  66:	5b                   	pop    %ebx
  67:	58                   	pop    %eax
  68:	6a 02                	push   $0x2
  6a:	56                   	push   %esi
  6b:	e8 9b 03 00 00       	call   40b <setnice>
	testgetnice(parent, 2);
  70:	58                   	pop    %eax
  71:	5a                   	pop    %edx
  72:	6a 02                	push   $0x2
  74:	56                   	push   %esi
  75:	e8 66 00 00 00       	call   e0 <testgetnice>
	printf(1, "##### Step 4 #####\n");
  7a:	59                   	pop    %ecx
  7b:	5b                   	pop    %ebx
  ...
  8b:	e8 53 03 00 00       	call   3e3 <getpid>
  90:	83 ec 04             	sub    $0x4,%esp
  93:	50                   	push   %eax
  94:	68 7f 08 00 00       	push   $0x87f
  99:	6a 01                	push   $0x1
  9b:	e8 40 04 00 00       	call   4e0 <printf>

  exit();
  a0:	e8 be 02 00 00       	call   363 <exit>
  a5:	89 c3                	mov    %eax,%ebx
	printf(1, "##### Step 1 #####\n");
  a7:	50                   	push   %eax
  a8:	50                   	push   %eax
  a9:	68 57 08 00 00       	push   $0x857
  ae:	6a 01                	push   $0x1
  ...
  b7:	6a 05                	push   $0x5
  b9:	53                   	push   %ebx
  ba:	e8 4c 03 00 00       	call   40b <setnice>
	testgetnice(child, 5);
  bf:	5e                   	pop    %esi
  c0:	58                   	pop    %eax
  c1:	6a 05                	push   $0x5
  c3:	53                   	push   %ebx
  c4:	e8 17 00 00 00       	call   e0 <testgetnice>
	printf(1, "##### Step 3 #####\n");
  c9:	58                   	pop    %eax
  ca:	5a                   	pop    %edx
  cb:	68 6b 08 00 00       	push   $0x86b
  d0:	6a 01                	push   $0x1
  d2:	e8 09 04 00 00       	call   4e0 <printf>
  d7:	83 c4 10             	add    $0x10,%esp
  da:	eb af                	jmp    8b <main+0x8b>
  dc:	66 90                	xchg   %ax,%ax
  de:	66 90                	xchg   %ax,%ax

000000e0 <testgetnice>:
{
  e0:	55                   	push   %ebp
  ...
  e9:	e8 25 03 00 00       	call   413 <getnice>
  ee:	83 c4 10             	add    $0x10,%esp
  f1:	3b 45 0c             	cmp    0xc(%ebp),%eax
  f4:	75 02                	jne    f8 <testgetnice+0x18>
}
  f6:	c9                   	leave  
  f7:	c3                   	ret    
  ...
  f8:	50                   	push   %eax
  f9:	50                   	push   %eax
  fa:	68 08 08 00 00       	push   $0x808
  ff:	6a 01                	push   $0x1
 101:	e8 da 03 00 00       	call   4e0 <printf>
    exit();
 106:	e8 58 02 00 00       	call   363 <exit>
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 f0 08 00 00 	movzbl 0x8f0(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 98 08 00 00 	jmp    *0x898(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 8e 08 00 00       	mov    $0x88e,%edx
        while(*s != 0){
 ...
 681:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 c4 0b 00 00 c8 	movl   $0xbc8,0xbc4
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf c8 0b 00 00       	mov    $0xbc8,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 7f2:	00 00 00 
    if(p->s.size >= nunits){
