...
int main(int argc, char** argv)
{
  ...
  12:	6a 00                	push   $0x0
  14:	6a 01                	push   $0x1
  16:	e8 00 04 00 00       	call   41b <setnice>
  setnice(getpid(), 2);
  1b:	e8 d3 03 00 00       	call   3f3 <getpid>
  20:	5a                   	pop    %edx
  21:	59                   	pop    %ecx
  22:	6a 02                	push   $0x2
  24:	50                   	push   %eax
  25:	e8 f1 03 00 00       	call   41b <setnice>
  ...
  2c:	6a 00                	push   $0x0
  2e:	6a 01                	push   $0x1
  30:	e8 bb 00 00 00       	call   f0 <testgetnice>
  testgetnice(getpid(), 2);
  35:	e8 b9 03 00 00       	call   3f3 <getpid>
  3a:	5a                   	pop    %edx
  3b:	59                   	pop    %ecx
  3c:	6a 02                	push   $0x2
  3e:	50                   	push   %eax
  3f:	e8 ac 00 00 00       	call   f0 <testgetnice>

  child1 = fork();
  44:	e8 22 03 00 00       	call   36b <fork>

  if (child1 == 0) {
  49:	83 c4 10             	add    $0x10,%esp
  4c:	85 c0                	test   %eax,%eax
  4e:	75 2b                	jne    7b <main+0x7b>
    printf(1, "##### Step 4 #####\n");
  50:	50                   	push   %eax
  51:	50                   	push   %eax
  52:	68 3f 08 00 00       	push   $0x83f
  57:	6a 01                	push   $0x1
  ...
  61:	e8 8d 03 00 00       	call   3f3 <getpid>
  66:	83 ec 04             	sub    $0x4,%esp
  69:	50                   	push   %eax
  6a:	68 8f 08 00 00       	push   $0x88f
  6f:	6a 01                	push   $0x1
  71:	e8 7a 04 00 00       	call   4f0 <printf>

  exit();
  76:	e8 f8 02 00 00       	call   373 <exit>
  ...
  7f:	6a 0a                	push   $0xa
  81:	53                   	push   %ebx
  82:	e8 94 03 00 00       	call   41b <setnice>
    testgetnice(child1, 10);
  87:	58                   	pop    %eax
  88:	5a                   	pop    %edx
  89:	6a 0a                	push   $0xa
  8b:	53                   	push   %ebx
  8c:	e8 5f 00 00 00       	call   f0 <testgetnice>
    printf(1, "##### Step 1 #####\n");
  91:	59                   	pop    %ecx
  92:	5b                   	pop    %ebx
  ...
  ab:	75 13                	jne    c0 <main+0xc0>
      printf(1, "##### Step 3 #####\n");
  ad:	50                   	push   %eax
  ae:	50                   	push   %eax
  af:	68 67 08 00 00       	push   $0x867
  b4:	6a 01                	push   $0x1
  b6:	e8 35 04 00 00       	call   4f0 <printf>
  bb:	83 c4 10             	add    $0x10,%esp
  be:	eb a1                	jmp    61 <main+0x61>
      setnice(child2, 5);
  c0:	50                   	push   %eax
  c1:	50                   	push   %eax
  c2:	6a 05                	push   $0x5
  c4:	53                   	push   %ebx
  c5:	e8 51 03 00 00       	call   41b <setnice>
      testgetnice(child2, 5);
  ca:	5a                   	pop    %edx
  cb:	59                   	pop    %ecx
  cc:	6a 05                	push   $0x5
  ce:	53                   	push   %ebx
  cf:	e8 1c 00 00 00       	call   f0 <testgetnice>
      printf(1, "##### Step 2 #####\n");
  d4:	5b                   	pop    %ebx
  d5:	58                   	pop    %eax
  d6:	68 7b 08 00 00       	push   $0x87b
  db:	6a 01                	push   $0x1
  dd:	e8 0e 04 00 00       	call   4f0 <printf>
...
000000f0 <testgetnice>:
{
  ...
  f9:	e8 25 03 00 00       	call   423 <getnice>
  fe:	83 c4 10             	add    $0x10,%esp
 101:	3b 45 0c             	cmp    0xc(%ebp),%eax
 104:	75 02                	jne    108 <testgetnice+0x18>
}
 106:	c9                   	leave  
 107:	c3                   	ret    
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 9e 08 00 00       	mov    $0x89e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 d0 0b 00 00       	mov    0xbd0,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 d0 0b 00 00    	mov    %edx,0xbd0
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 d0 0b 00 00    	mov    %edx,0xbd0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d d0 0b 00 00    	mov    0xbd0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d d0 0b 00 00    	mov    0xbd0,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 d0 0b 00 00    	mov    0xbd0,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 d0 0b 00 00    	mov    %edx,0xbd0
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 d0 0b 00 00 d4 	movl   $0xbd4,0xbd0
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf d4 0b 00 00       	mov    $0xbd4,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 d4 0b 00 00 d4 	movl   $0xbd4,0xbd4
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 d8 0b 00 00 00 	movl   $0x0,0xbd8
 802:	00 00 00 
    if(p->s.size >= nunits){
